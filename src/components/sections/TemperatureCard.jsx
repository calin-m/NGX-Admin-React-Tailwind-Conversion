    ...
    <div className="w-full rounded-2xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 shadow-lg p-6 flex flex-col justify-between space-y-6">
      <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700/60 pb-3">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">HVAC Climate Control</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-4 space-y-4">
        ...
        <div className="relative w-44 h-44 rounded-full border-8 border-slate-100 dark:border-slate-700/80 flex items-center justify-center shadow-inner">
      ...
      <div className="grid grid-cols-2 gap-4 pt-3 border-t border-slate-100 dark:border-slate-700/60 text-center">
        <div>
          ...
          <span className="text-sm font-bold text-slate-800 dark:text-slate-200">52%</span>
        </div>
        <div>
          <span className="text-[10px] text-slate-400 block">Air Quality</span>
          <span className="text-sm font-bold text-emerald-500">Good (98 AQI)</span>
        </div>
      </div>
    </div>
  );
