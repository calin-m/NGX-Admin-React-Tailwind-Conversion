...
/**
 * StatsCardBack Component
 * Modernized React 18 + Tailwind CSS v4 Component
 * Source Reference: old-src/ngx-admin-master <ngx-stats-card-back>
 */
export default function StatsCardBack(props) {
  return (
